...
function Game({ user, setUser, chat_message, setChat_message, game_board, setGame_board, current_room_name, setCurrent_room_name, room_list, setRoom_list, game_status, setGame_status, players, setPlayers, turn, setTurn, handleContent, userInput, userInputRoom, socketio, setUserInputRoom }) {
    return (
        <>
            <section id="room_section">
                <List user={user} current_room_name={current_room_name}
                    setCurrent_room_name={(data) => setCurrent_room_name(data)}
