...
function Game({ user, setUser, chat_message, setChat_message, game_board, setGame_board, current_room_name, setCurrent_room_name,room_list,setRoom_list, game_status, setGame_status, players,setPlayers,turn,setTurn,handleContent,userInput,userInputRoom,handleCreateRoom}) {
    return (
        <>
